...
import engine.mesh.MeshObject;
import engine.mesh.Model;
import engine.mesh.Triangle;
import engine.render.PixelRenderer3D;
...
public class PipeLine {
    ...
    public PipeLine(int[] p, int pW, int pH) {
        ...
        renderer = new PixelRenderer3D(p, pW, pH);
    ...
    public PipeLine(int pW, int pH) {
        ...
        renderer = new PixelRenderer3D(pW, pH);
