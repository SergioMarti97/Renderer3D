package org.render3d.mesh;

import org.render3d.material.Material;
import org.render3d.vectors.vec3d.Vec3df;
...
public class ObjReader {
     ...
     */
    public InputStream getFileFromResource(String fileName) throws URISyntaxException, FileNotFoundException {
    ...
    public boolean loadObj(String path, boolean hasTexture) {
        try {
            InputStreamReader streamReader = new InputStreamReader(getFileFromResource(path), StandardCharsets.UTF_8);
